...
x=function(e,f){return function(){return e(f)}}(B.FD,d)
x[$.ox()]=d
return x},
FD(d){return y.i.a(d).$0()},
FY(d){var x,w,v="AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz1234567890",u=$.B9(),t=J.ml(d,y.g)
...
AZ(){var x=b.G,w=y.h,v=w.a(w.a(x.window).localStorage),u=A.bG(v.getItem("state"))
if(u==null){u=B.FY(128)
v.setItem("state",u)}w.a(w.a(x.window).location).replace("https://api.brainiacs.in/oauth?state="+u)},
AX(d){var x=null,w=y.g,v=A.b([],y.p)
v.push(new D.cv(d,x))
return new E.aH("script",x,x,x,A.F(w,w),x,x,v,x)}},F,G
J=c[1]
A=c[0]
C=c[2]
E=c[27]
...
x($,"ID","B9",()=>{var w=new B.uy(new DataView(new ArrayBuffer(A.FH(8))))
w.nA()
return w})
x($,"K9","wm",()=>F.Hx(1))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.clients.dart.js_28",e:"endPart",h:b})})($__dart_deferred_initializers__,"S20IffmqyHbXoTZTF4KioeCDjdw=");
